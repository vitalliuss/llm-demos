...
if __name__ == '__main__':
    ...
    for index, row in dataframe.iterrows():
        ...
        try:
            ...
            ai_response = api_call_with_timeout(system_message, user_message, 30, "timeout reached") # seconds to wait for openai to respond
    ...
    print("Time spent, seconds: ", time_elapsed)